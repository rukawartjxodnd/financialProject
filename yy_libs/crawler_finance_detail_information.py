...
def getDetailFinanceInfo(companyCode):
    ...
    # page호출
    url = "http://comp.fnguide.com/SVO2/ASP/SVD_main.asp?pGB=1&gicode=A"+companyCode+"&cID=&MenuYn=Y&ReportGB=&NewMenuID=11&stkGb=&strResearchYN="
    ...
    return {"basicInfoGroup": basicInfoGroup, "subInfoGroup": subInfoGroup, "industryInfoGroup": industryInfoGroup, "annualInfoGroup": annualInfoGroup}
